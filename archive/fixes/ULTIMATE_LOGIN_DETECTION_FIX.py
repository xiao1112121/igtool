...
Vấn đề gốc:
1. check_home_and_explore_icons() không detect được với Chrome 137+
2. Instagram thay đổi DOM structure
3. JavaScript selectors không tìm thấy navigation elements
4. Quá phức tạp với icon detection

Giải pháp triệt để:
1. URL-based detection làm primary
2. Page title detection
3. Simple element count
4. Multiple fallback strategies
5. Force success nếu không ở login page
"""
